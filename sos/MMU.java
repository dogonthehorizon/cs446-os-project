...
public class MMU
{
    ...
    public void setStatus(int virtAddr, int newStatus)
    {
        ...
        //Construct the new value for this p5age table entry and write it to RAM
     ...
     * 
     * TODO
     * Calculate the page number and offset from the given virtual address.
     * 
     * @param virtAddr the address to translate.
