...
/**
 * This class simulates a memory management unit. Typically this is on the same
 * chip as the CPU but it is logically distinct.
 * 
 * The operating system is responsible for initializing and maintaining a page
 * table for this MMU. The MMU assumes that the page table is stored in the
 * bottom of RAM so that page numbers correspond directly to the physical
 * address of the page table entry correponding to that page. Each entry should
...
public class MMU {
	...
	/**
	 * This int will contain a 1 in every bit that corresponds to the offset of
	 * the virtual address and a 0 everywhere else.
	 */
	...
	/**
	 * This int will contain a 1 in every bit that corresponds to the page
	 * number of the virtual address and a 0 everywhere else.
	 */
	...
	// ----------------------------------------------------------------------
	/**
	 * the constructor initializes instance variables and initializes a page
	 * table
	 * 
	 * CAVEAT: The OS is responsible for initializing and maintaining the page
	 * table in RAM (@see MMU)
	 * 
	 * @param ram
	 *            a reference to the physical RAM
	 * @param size
	 *            the number of integers ("words") in virtual ram. If this is
	 *            not a power of 2, the value will be adjusted to the next power
	 *            of 2. If this number is less than the size of RAM it will be
	 *            adjusted to the size of RAM.
	 * @param pageSize
	 *            the number of integers ("words") in single page. If this
	...
	/**
	 * This constructor uses default values for pageSize and a virtual memory
	 * size of quadruple the RAM's size.
	 * 
	 * @param ram
	 *            a reference to the physical RAM
	 */
	 ...
	 * 
	 * @param virtAddr
	 *            the virtual address whose page's status is to be changed
	...
	public void setStatus(int virtAddr, int newStatus) {
		...
		// Construct the new value for this p5age table entry and write it to
		// RAM
	 ...
	 * translate
	 * 
	 * TODO Calculate the page number and offset from the given virtual address.
	 * 
	 * @param virtAddr
	 ...
	 * 
	 * @param virtAddr
	 *            the virtual address to write the data to
	 * @param data
	 *            the data to write
	 */
	 ...
	 * 
	 * @param virtAddr
	 *            the virtual address to read data from
	 ...
	 * 
	 * @param pc
	 *            the virtual address to load the instruction from (program
	 *            counter)
	 * 
	 * @return an array of int containing the instruction. The first entry in
	 *         the array is the opcode followed by the arguments in order.
	 * 
	 * @see CPU#INSTRSIZE
	 */
